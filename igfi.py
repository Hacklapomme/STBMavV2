...
def main(username: str, password: str, session: str):
    ...
    if num == 1:
        ...
        sleep(0.6)
        fname = os.path.join(os.path.dirname(os.path.abspath(__file__)), "/Users/dumancan/Desktop/consent.txt".replace('\\', '/'))
        ...
        clear()
        loc = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'files/log.txt').replace('\\', '/')
