...
print("""\33[90m         _____ _______ _____ _____ 
...
ses=requests.Session()
Dosyab=rootDir+"hits/𝐒𝐓𝐁√5𝐏𝐑𝐎/𝐅𝐔𝐋𝐋/𝐒𝐓𝐁√5𝐏𝐑𝐎{"+panel.replace(":","_").replace('/','')+"}#"+str(nickn)+"{ʜɪᴛs}.txt"

DosyaC =rootDir+"hits/𝐒𝐓𝐁√5𝐏𝐑𝐎/𝐒𝐇𝐎𝐑𝐓/𝐒𝐓𝐁√5𝐏𝐑𝐎{"+panel.replace(":","_").replace('/','')+"}#"+str(nickn)+"{ʜɪᴛs}.txt"
def yak(hits):
...
DosyaD =rootDir+"hits/𝐒𝐓𝐁√5𝐏𝐑𝐎/𝐌𝐀𝐂𝐬/𝐒𝐓𝐁√5𝐏𝐑𝐎{"+panel.replace(":","_").replace('/','')+"}#"+str(nickn)+"{ʜɪᴛs}.txt"
